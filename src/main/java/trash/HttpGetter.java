...
public class HttpGetter {
	...
	public HttpGetter(/*CommaFeedConfiguration config*/) {
		this.userAgent = String.format("CommaFeed/%s (https://www.commafeed.com)", "2.3.0-SNAPSHOT");
	}
	
	public HttpResult getBinary(String url, int timeout) throws NotModifiedException, IOException {
	 ...
	 */
	public HttpResult getBinary(String url, String lastModified, String eTag, int timeout) throws NotModifiedException, IOException
		 {
